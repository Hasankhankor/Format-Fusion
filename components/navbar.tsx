        ...
        <nav className="fixed z-50 flex items-center justify-between w-full h-24 px-4 py-10 backdrop-blur-md bg-background bg-opacity-30 md:px-8 lg:px-12 xl:px-16 2xl:px-24">
            <Link href="/">
                <div className="flex items-center">
                    <Image alt="logo" className="w-40 cursor-pointer dark:invert" src="/images/logo.svg" height={80} width={80} />
                    <span className="ml-3 text-2xl font-bold">Format Fusion</span>
                </div>
            </Link>
            ...
            <div className="items-center hidden gap-2 md:flex">
                <ModeToggle />
                <Link href="https://github.com/Hasankhankor/Format-Fusion">
